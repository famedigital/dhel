...
export interface CreateMenuProps {
  ...
  className?: string;
  /** Label on the closed trigger button */
  triggerLabel?: string;
  /** Where the morphing panel opens relative to the trigger */
...
export function CreateMenu({
  ...
  return (
    <div ref={ref} className={cn("relative inline-flex", className)}>
      ...
      <div
        className={cn(
          "pointer-events-none absolute z-30 w-[min(86vw,520px)] [&>*]:pointer-events-auto",
          placement === "below"
            ? "left-1/2 top-0 flex -translate-x-1/2 justify-center"
            : "left-1/2 top-1/2 grid h-[360px] -translate-x-1/2 -translate-y-1/2 place-items-center",
        )}
